...
import GripFab.GripFab;
import GripFab.PositionNotSupportedException;
...
public class AppGrip extends javax.swing.JApplet {
	...
	private GripFab1 gripFab = new GripFab1();
	...
	protected void chooseGripActionPerformed(ActionEvent evt) throws GripNotFoundException {
	...
	protected void chooseExtensionActionPerformed(ActionEvent evt) throws PositionNotSupportedException {
	...
	protected void chooseExtensionBActionPerformed(ActionEvent evt) throws PositionNotSupportedException {
	...
	protected void submitFileActionPerformed(ActionEvent evt) {
		...
		try {
			...
			e.printStackTrace();
		} catch (Interfaced.PositionNotSupportedException e) {
	...
	private void eA() {
		...
		extensionsBox.setModel(new javax.swing.DefaultComboBoxModel(extensions));
	...
	private void eB() {
		...
		extensionBBox.setModel(new javax.swing.DefaultComboBoxModel(extensionsB));
